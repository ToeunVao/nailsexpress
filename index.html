...
<section id="royalty-card-landing" class="py-20 bg-white">
    <div class="container mx-auto px-6 text-center">
        ...
        <p class="text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            We love our loyal clients! Sign up for our free Royalty Card and earn rewards with every visit. Get closer to a complimentary service with each stamp.
        </p>
        ...
        <main class="container mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
                        ...
                        <form id="add-appointment-form-landing" class="relative">
                            ...
                            <div id="booking-step-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2"><label for="appointment-datetime-landing"
            ...
            <section id="contact-landing" class="py-20">
                <div class="container mx-auto px-6 text-center">
                    ...
                    <div
                        class="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-12">
    ...
    <div id="client-dashboard-content" style="display: none;">
        ...
        <main class="container mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
            <div id="appointments-content" class="client-tab-content">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button id="client-book-new-btn"
                        class="bg-pink-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-pink-700">Book New
                        Appointment</button>
                </div>
            ...
            <!-- Royalty card will be rendered here by JavaScript -->
            </div>
        </main>
    </div>
            ...
            <div id="dashboard-content">
                ...
                <div id="admin-dashboard-view" class="hidden">
                    <div id="admin-quick-nav"
                        class="sticky top-0 bg-white/80 backdrop-blur-md z-30 p-2 mb-6 rounded-lg shadow flex justify-between items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-1">
            <form id="add-task-form" class="space-y-4">
                <div>
                    <label for="task-description" class="block text-sm font-medium text-gray-600">New Task</label>
                    <input type="text" id="task-description" class="form-input w-full mt-1" placeholder="e.g., Order more DND #401" required>
                </div>
                <div>
                    <label for="task-priority" class="block text-sm font-medium text-gray-600">Priority</label>
                    <select id="task-priority" class="form-select w-full mt-1">
                        <option value="low">Low</option>
                        <option value="medium" selected>Medium</option>
                        <option value="high">High</option>
                    </select>
                </div>
                <button type="submit" class="w-full bg-pink-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-pink-700">
        ...
        <div class="md:col-span-2">
            <div id="task-list-container" class="space-y-3 max-h-72 overflow-y-auto pr-2">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-xl">
                    ...
                    <div id="nails-idea-content" class="main-section hidden">
                        ...
                        <div class="flex flex-wrap gap-4 mb-8">
                            ...
                            <select id="nail-idea-category-filter"
                                class="form-select p-2 border border-gray-300 rounded-lg">
                        ...
                        <div id="staff-earning-report-content" class="sub-tab-content hidden">
                            ...
                            <form id="staff-earning-form" class="grid grid-cols-1 md:grid-cols-6 gap-6 mb-8 items-end">
                                ...
                                <div><label for="staff-tip"
                                        ...
                                        class="form-input w-full p-3 border border-gray-300 rounded-lg"
                                        placeholder="e.g., 20" required></div>
                                ...
                                <table id="staff-earning-table" class="w-full text-sm text-left text-gray-600">
                                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 sticky top-0">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-3">Tip</th>
                                            <th scope="col" class="px-6 py-3 text-center"
                                                id="report-earning-action-header">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot class="bg-gray-100 sticky bottom-0 font-semibold">
...
<div class="flex justify-end items-center mb-4 gap-4">
    <div>
        <label for="expense-category-filter" class="text-sm font-medium text-gray-700 mr-2">Category:</label>
        <select id="expense-category-filter" class="form-select p-2 border border-gray-300 rounded-lg"></select>
    </div>
    <div>
        <label for="expense-supplier-filter" class="text-sm font-medium text-gray-700 mr-2">Supplier:</label>
        <select id="expense-supplier-filter" class="form-select p-2 border border-gray-300 rounded-lg"></select>
    </div>
    <div>
        <label for="expense-month-filter" class="text-sm font-medium text-gray-700 mr-2">Month:</label>
...
<!-- ...WITH this new div that includes the button: -->
<div class="flex justify-between items-center mb-4">
    <h3 class="text-xl font-semibold text-gray-700">Royalty Cards</h3>
    <div class="flex items-center gap-2">
        <input type="text" id="search-royalty-cards" class="form-input w-64 p-2 border border-gray-300 rounded-lg" placeholder="Search by name or phone...">
        <button id="add-royalty-card-btn" class="bg-pink-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-pink-700 whitespace-nowrap"><i class="fas fa-plus mr-2"></i>Add for Client</button>
    </div>
</div>
    <div class="overflow-x-auto">
...
<li class="mr-2"><button class="sub-tab-btn inline-block p-4 rounded-t-lg" 
        id="backup-management-tab" type="button">Backup & Restore</button></li>
                        ...
                        <div id="user-management-content" class="sub-tab-content">
                            ...
                            <form id="add-user-form" class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 p-4 border rounded-lg bg-gray-50 items-end">
                                ...
                                <div><label for="user-role"
                                    ...
                                    <!-- PASTE THIS NEW DIV HERE -->
<div>
    <label for="payout-type" class="block text-sm font-medium text-gray-600">Payout Type</label>
                            ...
                            <form id="add-nail-idea-form"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div id="nail-idea-url-container" class="hidden">
                                        ...
                                        <input type="url" id="nail-idea-image-url"
                                            ...
                                            <div id="printable-gift-card-area">
                                                <div id="printable-gift-card"
                                                    ...
                                                    <div class="flex justify-between items-start"
                                                        ...
                                                        <img id="preview-logo"
                                                            src="https://placehold.co/100x100/d63384/FFFFFF?text=NE"
...
<div id="royalty-management-content" class="sub-tab-content hidden">
    ...
    <form id="royalty-settings-form" class="p-4 border rounded-lg bg-gray-50 space-y-4 max-w-lg">
        <div>
            <label for="royalty-visits-needed" class="block text-sm font-medium text-gray-600">Visits Required for Reward</label>
            <input type="number" id="royalty-visits-needed" class="form-input w-full mt-1" min="1" value="10">
        </div>
        <div>
            <label for="royalty-reward-description" class="block text-sm font-medium text-gray-600">Reward Description</label>
            <input type="text" id="royalty-reward-description" class="form-input w-full mt-1" placeholder="e.g., One Free Classic Manicure">
        </div>
        <div class="text-right">
            <button type="submit" class="bg-pink-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-pink-700">Save Settings</button>
        </div>
    </form>
    <!-- PASTE THIS NEW DESIGNER SECTION -->
<div class="mt-8">
    <h3 class="text-xl font-semibold text-gray-700 mb-4">Printable Royalty Card Designer</h3>
    <div class="bg-gray-50 p-6 rounded-2xl border grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <!-- Designer Controls -->
        <div class="space-y-4">
            <form id="royalty-card-designer-form" class="space-y-4">
                <div>
                    <label for="designer-royalty-quantity" class="block text-sm font-medium text-gray-600">Quantity to Generate & Print</label>
                    <input type="number" id="designer-royalty-quantity" class="form-input w-full p-2 mt-1 border-gray-300 rounded-lg" min="1" value="4">
                </div>
            </form>
            <div class="mt-6 text-center">
                <button id="print-royalty-cards-btn" class="w-full bg-green-500 text-white font-bold py-3 px-12 rounded-full hover:bg-green-600">
                    <i class="fas fa-print mr-2"></i>Generate & Print Cards
                </button>
            </div>
             <p class="text-xs text-center text-gray-500 mt-2">The number of stamps on the card is based on the "Visits Required" setting above.</p>
        </div>
        ...
        <div class="flex items-center justify-center">
            <div id="printable-royalty-card-area" class="space-y-4 transform scale-90">
                <!-- Front Preview -->
                <div id="royalty-card-preview-front" class="card rounded-lg p-4 flex flex-col justify-between bg-gradient-to-br from-pink-50 to-pink-200 text-pink-900" style="width:400px; height:228px; text-shadow: none;">
                </div>
                <!-- Back Preview -->
                <div id="royalty-card-preview-back" class="card rounded-lg p-4 flex flex-col justify-between bg-white text-gray-800" style="width:400px; height:228px; text-shadow: none;">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <div id="feature-toggles-form" class="p-4 border rounded-lg bg-gray-50 space-y-4">
                                        ...
                                        <!-- PASTE THIS NEW TOGGLE SWITCH BLOCK -->
<div class="flex items-center justify-between">
    <span class="text-sm font-medium text-gray-900">Show Royalty Card Section</span>
    <label for="toggle-royalty-card" class="relative inline-flex items-center cursor-pointer">
...
<div id="backup-management-content" class="sub-tab-content hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-6 border rounded-lg bg-gray-50 space-y-4">
            ...
            <p class="text-sm text-gray-600">Download a complete backup of all salon data to a single JSON file. You can restore from this file at any time.</p>
            <div>
                <button id="backup-data-btn" class="w-full bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 flex items-center justify-center">
                    <i class="fas fa-download mr-2"></i> Backup All Data
                </button>
            </div>
            <div class="border-t pt-4">
                <label for="restore-data-input" class="block text-sm font-medium text-gray-600">Restore from Backup File</label>
                <input type="file" id="restore-data-input" class="form-input w-full mt-1 text-sm" accept=".json">
                <p class="text-xs text-red-600 mt-1 font-semibold">Warning: Restoring will overwrite all current data. This action cannot be undone.</p>
            </div>
        </div>
        ...
        <div class="p-6 border rounded-lg bg-gray-50 space-y-4">
            ...
            <p class="text-sm text-gray-600">The application can automatically prompt you to download a backup file if one hasn't been created recently.</p>
            <div>
                <label for="auto-backup-frequency" class="block text-sm font-medium text-gray-600">Backup Frequency</label>
            ...
            <div class="border-t pt-4">
                 ...
                 <p id="last-backup-status" class="text-sm text-gray-800 font-semibold mt-1">No backup recorded.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="appointment-services-container" class="grid grid-cols-2 md:grid-cols-3 gap-2 mt-1">
        <!-- Service category buttons will be added here by JavaScript -->
    </div>
    <div id="appointment-hidden-checkboxes" class="hidden"></div>
</div>
                ...
                <div class="md:col-span-2"><label for="appointment-datetime"
                        class="block text-sm font-medium text-gray-600">Date & Time</label><input type="datetime-local"
                        id="appointment-datetime" class="form-input w-full p-2 mt-1 border border-gray-300 rounded-lg"
                        required></div>
    ...
    <div id="client-form-modal" class="fixed inset-0 z-50 hidden items-center justify-center">
        ...
        <form id="client-form" class="relative bg-white w-full max-w-lg p-6 rounded-2xl shadow-xl m-4">
            ...
            <div class="space-y-4">
                ...
                <div>
    <label for="client-form-email" class="block text-sm font-medium text-gray-600 mb-1">Email Address (Optional)</label>
    <input type="email" id="client-form-email" class="form-input w-full p-3 border border-gray-300 rounded-lg">
</div>
                <div>
    ...
    <div id="edit-gift-card-modal" class="modal hidden fixed inset-0 z-[60] flex items-center justify-center p-4">
        ...
        <div class="relative bg-white w-full max-w-2xl p-6 rounded-2xl shadow-xl m-4 max-h-[90vh] overflow-y-auto">
            ...
            <div class="text-center mb-4">
                <p class="font-mono text-lg" id="edit-gc-code"></p>
            </div>
    ...
    <div id="nail-idea-lightbox"
        ...
        <div class="relative w-full max-w-4xl h-full flex items-center justify-center">
            ...
            <div
                ...
                <div class="w-full lg:w-2/3 h-64 lg:h-full bg-gray-900 flex items-center justify-center">
...
<div id="royalty-card-modal" class="modal hidden fixed inset-0 z-[60] flex items-center justify-center p-4">
    <div class="modal-overlay absolute inset-0 bg-black opacity-50"></div>
    <div class="relative bg-white w-full max-w-lg p-6 rounded-2xl shadow-xl m-4">
        <button id="close-royalty-card-modal-btn" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600"><i class="fas fa-times fa-lg"></i></button>
        ...
        <form id="royalty-card-form" class="space-y-4">
            <p class="text-sm text-center text-gray-600">Provide your details below to receive your digital royalty card and start earning rewards!</p>
            <div>
                <label for="rc-buyer-name" class="block text-sm font-medium text-gray-600">Full Name</label>
                <input type="text" id="rc-buyer-name" class="form-input w-full p-2 mt-1 border border-gray-300 rounded-lg" required>
            </div>
            <div>
                <label for="rc-buyer-phone" class="block text-sm font-medium text-gray-600">Phone Number</label>
                <input type="tel" id="rc-buyer-phone" class="form-input w-full p-2 mt-1 border border-gray-300 rounded-lg" required>
            </div>
            <div>
                <label for="rc-buyer-email" class="block text-sm font-medium text-gray-600">Email Address</label>
                <input type="email" id="rc-buyer-email" class="form-input w-full p-2 mt-1 border border-gray-300 rounded-lg" required>
                <p class="text-xs text-gray-500 mt-1">An account will be created for you to track your rewards online.</p>
            </div>
            <div class="pt-4">
                <button type="submit" id="royalty-card-submit-btn" class="w-full bg-pink-600 text-white font-bold py-3 px-12 rounded-full hover:bg-pink-700">
                    Sign Up & Get My Card
                </button>
            </div>
        </form>
...
<div id="add-royalty-card-modal" class="modal hidden fixed inset-0 z-[70] flex items-center justify-center p-4">
    <div class="modal-overlay absolute inset-0 bg-black opacity-50"></div>
    <div class="relative bg-white w-full max-w-lg p-6 rounded-2xl shadow-xl m-4">
        <button id="close-add-royalty-card-modal-btn" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600"><i class="fas fa-times fa-lg"></i></button>
        ...
        <form id="add-royalty-card-form" class="space-y-4">
            <div>
                ...
                <input type="text" id="add-rc-client-name" list="add-rc-client-list" class="form-input w-full p-2 mt-1 border border-gray-300 rounded-lg" required placeholder="Start typing to search for a client...">
                <datalist id="add-rc-client-list"></datalist>
            </div>
            <p class="text-xs text-center text-gray-500">Select an existing client to add a new royalty card to their account. Their visit count will be set to zero.</p>
            <div class="pt-4">
                <button type="submit" id="add-royalty-card-submit-btn" class="w-full bg-pink-600 text-white font-bold py-3 px-12 rounded-full hover:bg-pink-700">
                    Create Card
                </button>
            </div>
        </form>
...
<div id="edit-task-modal" class="modal hidden fixed inset-0 z-[70] flex items-center justify-center p-4">
    <div class="modal-overlay absolute inset-0 bg-black opacity-50"></div>
    <div class="relative bg-white w-full max-w-lg p-6 rounded-2xl shadow-xl m-4">
        <button id="close-edit-task-modal-btn" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600"><i class="fas fa-times fa-lg"></i></button>
        <h2 class="text-2xl font-bold text-center text-pink-700 mb-6">Edit Task</h2>
        <form id="edit-task-form" class="space-y-4">
            <input type="hidden" id="edit-task-id">
            <div>
                <label for="edit-task-description" class="block text-sm font-medium text-gray-600">Task Description</label>
                <input type="text" id="edit-task-description" class="form-input w-full mt-1" required>
            </div>
            <div>
                <label for="edit-task-priority" class="block text-sm font-medium text-gray-600">Priority</label>
                <select id="edit-task-priority" class="form-select w-full mt-1">
                    <option value="low">Low</option>
